...
import org.example.org.example.utils.logger.mdc.MDCContext.Key
...
class MDCContext(
    ...
    companion object Key :CoroutineContext.Key<MDCContext> // is an interface used to retrieve specific elements from a CoroutineContext
